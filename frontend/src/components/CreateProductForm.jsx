...
const fragranceTypes = ["Eau de Parfum", "Eau de Toilette", "Eau de Cologne", "Parfum"];
...
const CreateProductForm = () => {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-semibold mb-6 text-emerald-300">Add New Perfume</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Describe the scent, top notes, or inspiration..."
            className="mt-1 block w-full bg-gray-700 border border-gray-600 rounded-md shadow-sm py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
            required
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            required
          >
            <option value="">Select a fragrance family</option>
            {categories.map((cat) => (
        ...
        {/* Type */}
        <div>
          <label htmlFor="fragranceType" className="block text-sm font-medium text-gray-300">
            Fragrance Type
          </label>
          <select
            id="fragranceType"
            value={newProduct.fragranceType}
            onChange={(e) => setNewProduct({ ...newProduct, fragranceType: e.target.value })}
            className="mt-1 block w-full bg-gray-700 border border-gray-600 rounded-md shadow-sm py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
          >
